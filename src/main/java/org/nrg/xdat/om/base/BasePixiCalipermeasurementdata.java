...
import org.nrg.xdat.om.base.auto.AutoPixiCalipermeasurementdata;
...
public abstract class BasePixiCalipermeasurementdata extends AutoPixiCalipermeasurementdata {

	public BasePixiCalipermeasurementdata(ItemI item)
	{
		super(item);
	}

	public BasePixiCalipermeasurementdata(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use BasePixiCalipermeasurementdata(UserI user)
	 **/
	public BasePixiCalipermeasurementdata()
	{}

	public BasePixiCalipermeasurementdata(Hashtable properties, UserI user)
	{
	...
	private static final String QUERY_COUNT_WEIGHT_EXPERIMENTS_BY_SUBJECT_ID = "SELECT COUNT(*) " +
			"FROM pixi_calipermeasurementdata as w INNER JOIN (" +
