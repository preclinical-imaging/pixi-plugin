...
import org.nrg.xdat.om.base.auto.AutoPixiWeightdata;
...
/**
 * Override of generated implementation of this class to count weight experiments by subject.
 */
public abstract class BasePixiWeightdata extends AutoPixiWeightdata {

	public BasePixiWeightdata(ItemI item) {
		super(item);
	}

	public BasePixiWeightdata(UserI user) {
		super(user);
	}

	/*
	 * @deprecated Use BasePixiWeightdata(UserI user)
	 **/
	public BasePixiWeightdata() {
	}

	public BasePixiWeightdata(Hashtable properties, UserI user) {
	...
	private static final String QUERY_COUNT_WEIGHT_EXPERIMENTS_BY_SUBJECT_ID = "SELECT COUNT(*) " +
																			   "FROM pixi_weightData as w INNER JOIN (" +
