...
public interface BiodistributionDataService {
    ...
    List<PixiBiodistributiondataI> fromCsv(final UserI user, final String project, final String userCachePath) throws Exception;
    List<PixiBiodistributiondataI> fromCsv(final UserI user, final String project, final File file) throws Exception;
