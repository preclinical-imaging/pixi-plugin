...
public interface BiodistributionDataService {
    ...
    Optional<PixiBiodistributiondataI> createOrUpdate(final UserI user, final PixiBiodistributiondataI biodistributionData, String dataOverlapHandling) throws Exception;
